...
* File:    14_supplementary_table9_precipitation_threshold_table.do
* Purpose: Reproduce Supplementary Table 9 precipitation-bin regressions
...
log using "${LOGS}/14_supplementary_table9_precipitation_threshold_table.log", replace text
...
********************************************************************************
* 4. Export Supplementary Table 9
********************************************************************************
...
esttab S9_all S9_semi S9_humid S9_hyper ///
    using "${OUTPUT}/supplementary_tables/supplementary_table9_precipitation_thresholds.rtf", ///
    replace rtf label ///
...
esttab S9_all S9_semi S9_humid S9_hyper ///
    using "${OUTPUT}/supplementary_tables/supplementary_table9_precipitation_thresholds.csv", ///
    replace csv label ///
    mtitles("All samples" "Semi-humid" "Humid" "Hyper-humid") ///
    keep(`keep_order') ///
    order(`keep_order') ///

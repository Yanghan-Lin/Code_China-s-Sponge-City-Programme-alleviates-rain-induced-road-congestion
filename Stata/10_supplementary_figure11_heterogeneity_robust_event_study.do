...
* File:    10_supplementary_figure11_heterogeneity_robust_event_study.do
...
log using "${LOGS}/10_supplementary_figure11_heterogeneity_robust_event_study.log", replace text
